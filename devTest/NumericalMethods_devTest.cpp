...
int main( int argc, char *argv[] ) {
    ...
    std::string res1 = Support::NumericalMethodsSupport::rootSolver_results(ans1);
    printf("%s\n", res1.c_str());
    ...
    std::string res5 = Support::NumericalMethodsSupport::rootSolver_results(ans5);
    printf("%s\n", res5.c_str());
    ...
    std::string res6 = Support::NumericalMethodsSupport::rootSolver_results(ans6);
    printf("%s\n", res6.c_str());
    
    printf("NM Steffenson's Method Test\n");
    ans7 = NumericalMethods::RootSolvers::steffensens_method(&function_4, 0.5, 1e-04);
    std::string res7 = Support::NumericalMethodsSupport::rootSolver_results(ans7);
    printf("%s\n", res7.c_str());
